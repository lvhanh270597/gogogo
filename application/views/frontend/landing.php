...
<body class="restaurant-lp">
                    ...
                    <div class="row smooth-scroll">
                        <div class="col-md-12 dark-grey-text text-center">
                            <div class="wow fadeInDown" data-wow-delay="0.2s">
                                <h2 class="display-3 font-weight-bold mb-2">Restaurant</h2>
                                <hr class="hr-dark">
                                <h4 class="subtext-header mt-2 mb-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h4>
                                <h4 class="mb-5"> Deleniti consequuntur, nihil voluptatem modi nobis veniam.</h4>
                            </div>
    ...
    <main>
            ...
            <div class="flex-center mask rgba-black-strong">
                <div class="text-center white-text">
                    <h2 class="h2-responsive mb-5">
                        <i class="fa fa-quote-left" aria-hidden="true"></i> Food for the body is not enough. There must be food for the soul.
        ...
        <div class="streak streak-photo streak-long-2" style="background-image:url('https://mdbootstrap.com/img/Others/food5.jpg')">
            <div class="mask flex-center rgba-black-strong">
                <div class="container">
                    ...
                    <h2 class="text-center text-white mb-5 text-uppercase font-weight-bold wow fadeIn" data-wow-delay="0.2s">Great people trusted our services</h2>
        ...
        <!--Section: Menu-->
        <div class="container">
            <section class="section my-4" id="products">

                <!--Secion heading-->
                <div class="row mt-5 mb-4">
                    <div class="col-md-12 div-color-2">
                        <div class="divider-new">
                            <h3 class="text-center text-uppercase font-weight-bold mr-3 ml-3 wow fadeIn" data-wow-delay="0.2s">The menu</h3>
                        </div>
                    </div>
                </div>

                <!--Section description-->
                <p class="text-center grey-text w-responsive mx-auto mb-5 wow fadeIn" data-wow-delay="0.2s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error amet numquam iure provident voluptate
        ...
        <section id="testimonials" class="section team-section mt-2 mb-6">
            <div class="container">
                <!--Secion heading-->
                <div class="row mt-5 mb-4">
                    <div class="col-md-12 div-color-2">
                        <div class="divider-new">
                            <h3 class="text-center text-uppercase font-weight-bold mr-3 ml-3 wow fadeIn" data-wow-delay="0.2s">Our Guests opinions</h3>
                        </div>
                    </div>
                    <!--/Secion heading-->
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            ...
                            <div class="testimonial">
                                ...
                                <p>
                                    <i class="fa fa-quote-left "></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic
                        ...
                        <div class="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="testimonial">
                                ...
                                <p>
                                    <i class="fa fa-quote-left"></i> Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam,
                        ...
                        <div class="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="testimonial">
                                ...
                                <p>
                                    <i class="fa fa-quote-left"></i> At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
        ...
        <div class="container mb-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 pt-1 pb-3 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p class="mb-1-half"> Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint.</p>
                    <!--/About -->
